      ...
      <section class="content mt-2">
        <div class="card card-primary">
          ...
          if ($_GET['id']) {
            ...
            $sql = " SELECT * FROM status_master WHERE id='" . $_GET['id'] . "'";
            ...
            <form role="form" action="update.php?id=<?php echo $value['id']; ?>" method="post">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="statusname">ชื่อสถานะงาน</label>
                  <input type="text" class="form-control" id="statusname" name="statusname" value="<?php echo $value['status_name']; ?>">
                </div>

                <div class="form-group">
                  <label for="description">คำอธิบาย</label>
                  <input type="text" class="form-control" id="description" name="description" value="<?php echo $value['status_description']; ?>">
                </div>
