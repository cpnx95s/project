    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Status Management</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title d-inline-block">Status List</h3>
            <a href="form-create.php" class="btn btn-primary float-right ">Add Status +</a href="">
          </div>
          <!-- /.card-header -->
          <div class="card-body">
