          ...
          <div class="card-body">
            <table id="dataTable" class="table table-striped">
              ...
              <tbody>
                ...
                $sql = "select t.id, t.name, t.launch_date, t.launch_time, t.created, t.channel_id, t.create_by,t.update_by,  t.status_master_id,  c.name as channel_name,
                ...
                where t.status_master_id = 3 and t.update_by = $user_id ";
