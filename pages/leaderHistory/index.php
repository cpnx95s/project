              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>คุณได้เปลี่ยนสถานะรายการงาน <strong style="color:red;"><?php echo $value['ชื่อช่องทางสังคมออนไลน์']; ?> : <?php echo $value['taskname']; ?></strong> เป็น <strong style="color:red;"><?php echo $statusth1; ?></strong> เมื่อวันที่ <?php echo $value['actiondate']; ?> เวลา <?php echo substr($value['actiontime'], 0, 5); ?> น.</td>
