...
<nav class="main-header navbar navbar-expand border-bottom navbar-dark bg-success">
  ...
  $sql3 = "SELECT * FROM user WHERE id = $user_id3 ";
  ...
  <ul class="navbar-nav ml-auto">
    <li class="nav-item">
      ...
      <i class="fa fa-user" aria-hidden="true"></i> <?php echo $value3['surname'] . ' ' . $value3['name']; ?></td>
      </a>
    </li>
  </ul>
</nav>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="#" class="brand-link">
    <span class="brand-text font-weight-light text-center d-block">Customer Panel</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="#" class="d-block"><?php echo $value3['surname'] . ' ' . $value3['name']; ?></a>
      </div>
    </div>
